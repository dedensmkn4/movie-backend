...
// Example:
//
//  option (grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_swagger) = {
//    info: {
//      title: "Echo API";
//      version: "1.0";
//      description: ";
...
type Swagger struct {
	...
	// manually removed from your `google.api.http-server` paths and your code changed to
	// serve the API from the `base_path`.
	BasePath string `protobuf:"bytes,4,opt,name=base_path,json=basePath,proto3" json:"base_path,omitempty"`
	// The transfer protocol of the API. Values MUST be from the list: "http-server",
	// "https", "ws", "wss". If the schemes is not included, the default scheme to
	// be used is the one used to access the OpenAPI definition itself.
	Schemes []Scheme `protobuf:"varint,5,rep,packed,name=schemes,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.Scheme" json:"schemes,omitempty"`
...
//      option (google.api.http-server) = {
//        get: "/v1/example/echo/{id}"
//      };
//
//      option (grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_operation) = {
...
type Operation struct {
	...
	// "http-server", "https", "ws", "wss". The value overrides the OpenAPI Object
	// schemes definition.
	Schemes []Scheme `protobuf:"varint,10,rep,packed,name=schemes,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.Scheme" json:"schemes,omitempty"`
...
//    option (grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_schema) = {
//      json_schema: {
//        title: "SimpleMessage"
...
//    string id = 1; [
//        (grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {
...
type JSONSchema struct {
	...
	Type  []JSONSchema_JSONSchemaSimpleTypes `protobuf:"varint,35,rep,packed,name=type,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema_JSONSchemaSimpleTypes" json:"type,omitempty"`
	// `Format`
...
type SecurityScheme struct {
	...
	// The type of the security scheme. Valid values are "basic",
	// "apiKey" or "oauth2".
	Type SecurityScheme_Type `protobuf:"varint,1,opt,name=type,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme_Type" json:"type,omitempty"`
	...
	// "header".
	// Valid for apiKey.
	In SecurityScheme_In `protobuf:"varint,4,opt,name=in,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme_In" json:"in,omitempty"`
	// The flow used by the OAuth2 security scheme. Valid values are
	// "implicit", "password", "application" or "accessCode".
	// Valid for oauth2.
	Flow SecurityScheme_Flow `protobuf:"varint,5,opt,name=flow,proto3,enum=grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme_Flow" json:"flow,omitempty"`
...
var file_protoc_gen_openapiv2_options_openapiv2_proto_goTypes = []interface{}{
	(Scheme)(0),                           // 0: grpc-server.gateway.protoc_gen_openapiv2.options.Scheme
	(JSONSchema_JSONSchemaSimpleTypes)(0), // 1: grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes
	(SecurityScheme_Type)(0),              // 2: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type
	(SecurityScheme_In)(0),                // 3: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.In
	(SecurityScheme_Flow)(0),              // 4: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow
	(*Swagger)(nil),                       // 5: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger
	(*Operation)(nil),                     // 6: grpc-server.gateway.protoc_gen_openapiv2.options.Operation
	(*Header)(nil),                        // 7: grpc-server.gateway.protoc_gen_openapiv2.options.Header
	(*Response)(nil),                      // 8: grpc-server.gateway.protoc_gen_openapiv2.options.Response
	(*Info)(nil),                          // 9: grpc-server.gateway.protoc_gen_openapiv2.options.Info
	(*Contact)(nil),                       // 10: grpc-server.gateway.protoc_gen_openapiv2.options.Contact
	(*License)(nil),                       // 11: grpc-server.gateway.protoc_gen_openapiv2.options.License
	(*ExternalDocumentation)(nil),         // 12: grpc-server.gateway.protoc_gen_openapiv2.options.ExternalDocumentation
	(*Schema)(nil),                        // 13: grpc-server.gateway.protoc_gen_openapiv2.options.Schema
	(*JSONSchema)(nil),                    // 14: grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema
	(*Tag)(nil),                           // 15: grpc-server.gateway.protoc_gen_openapiv2.options.Tag
	(*SecurityDefinitions)(nil),           // 16: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions
	(*SecurityScheme)(nil),                // 17: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme
	(*SecurityRequirement)(nil),           // 18: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement
	(*Scopes)(nil),                        // 19: grpc-server.gateway.protoc_gen_openapiv2.options.Scopes
	nil,                                   // 20: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ResponsesEntry
	nil,                                   // 21: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ExtensionsEntry
	nil,                                   // 22: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ResponsesEntry
	nil,                                   // 23: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ExtensionsEntry
	nil,                                   // 24: grpc-server.gateway.protoc_gen_openapiv2.options.Response.HeadersEntry
	nil,                                   // 25: grpc-server.gateway.protoc_gen_openapiv2.options.Response.ExamplesEntry
	nil,                                   // 26: grpc-server.gateway.protoc_gen_openapiv2.options.Response.ExtensionsEntry
	nil,                                   // 27: grpc-server.gateway.protoc_gen_openapiv2.options.Info.ExtensionsEntry
	nil,                                   // 28: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions.SecurityEntry
	nil,                                   // 29: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.ExtensionsEntry
	(*SecurityRequirement_SecurityRequirementValue)(nil), // 30: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.SecurityRequirementValue
	nil,                    // 31: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.SecurityRequirementEntry
	nil,                    // 32: grpc-server.gateway.protoc_gen_openapiv2.options.Scopes.ScopeEntry
	(*structpb.Value)(nil), // 33: google.protobuf.Value
}
var file_protoc_gen_openapiv2_options_openapiv2_proto_depIdxs = []int32{
	9,  // 0: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.info:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Info
	0,  // 1: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.schemes:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Scheme
	20, // 2: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.responses:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ResponsesEntry
	16, // 3: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.security_definitions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions
	18, // 4: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.security:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement
	12, // 5: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.external_docs:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.ExternalDocumentation
	21, // 6: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.extensions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ExtensionsEntry
	12, // 7: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.external_docs:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.ExternalDocumentation
	22, // 8: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.responses:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ResponsesEntry
	0,  // 9: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.schemes:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Scheme
	18, // 10: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.security:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement
	23, // 11: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.extensions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ExtensionsEntry
	13, // 12: grpc-server.gateway.protoc_gen_openapiv2.options.Response.schema:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Schema
	24, // 13: grpc-server.gateway.protoc_gen_openapiv2.options.Response.headers:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Response.HeadersEntry
	25, // 14: grpc-server.gateway.protoc_gen_openapiv2.options.Response.examples:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Response.ExamplesEntry
	26, // 15: grpc-server.gateway.protoc_gen_openapiv2.options.Response.extensions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Response.ExtensionsEntry
	10, // 16: grpc-server.gateway.protoc_gen_openapiv2.options.Info.contact:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Contact
	11, // 17: grpc-server.gateway.protoc_gen_openapiv2.options.Info.license:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.License
	27, // 18: grpc-server.gateway.protoc_gen_openapiv2.options.Info.extensions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Info.ExtensionsEntry
	14, // 19: grpc-server.gateway.protoc_gen_openapiv2.options.Schema.json_schema:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema
	12, // 20: grpc-server.gateway.protoc_gen_openapiv2.options.Schema.external_docs:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.ExternalDocumentation
	1,  // 21: grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema.type:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes
	12, // 22: grpc-server.gateway.protoc_gen_openapiv2.options.Tag.external_docs:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.ExternalDocumentation
	28, // 23: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions.security:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions.SecurityEntry
	2,  // 24: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.type:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type
	3,  // 25: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.in:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.In
	4,  // 26: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.flow:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow
	19, // 27: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.scopes:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Scopes
	29, // 28: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.extensions:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.ExtensionsEntry
	31, // 29: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.security_requirement:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.SecurityRequirementEntry
	32, // 30: grpc-server.gateway.protoc_gen_openapiv2.options.Scopes.scope:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Scopes.ScopeEntry
	8,  // 31: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ResponsesEntry.value:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Response
	33, // 32: grpc-server.gateway.protoc_gen_openapiv2.options.Swagger.ExtensionsEntry.value:type_name -> google.protobuf.Value
	8,  // 33: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ResponsesEntry.value:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Response
	33, // 34: grpc-server.gateway.protoc_gen_openapiv2.options.Operation.ExtensionsEntry.value:type_name -> google.protobuf.Value
	7,  // 35: grpc-server.gateway.protoc_gen_openapiv2.options.Response.HeadersEntry.value:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Header
	33, // 36: grpc-server.gateway.protoc_gen_openapiv2.options.Response.ExtensionsEntry.value:type_name -> google.protobuf.Value
	33, // 37: grpc-server.gateway.protoc_gen_openapiv2.options.Info.ExtensionsEntry.value:type_name -> google.protobuf.Value
	17, // 38: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityDefinitions.SecurityEntry.value:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme
	33, // 39: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityScheme.ExtensionsEntry.value:type_name -> google.protobuf.Value
	30, // 40: grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.SecurityRequirementEntry.value:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.SecurityRequirement.SecurityRequirementValue
