...
var file_protoc_gen_openapiv2_options_annotations_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         1042,
		Name:          "grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_swagger",
	...
	},
	{
		...
		Field:         1042,
		Name:          "grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_operation",
	...
	},
	{
		...
		Field:         1042,
		Name:          "grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_schema",
	...
	},
	{
		...
		Field:         1042,
		Name:          "grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_tag",
	...
	},
	{
		...
		Field:         1042,
		Name:          "grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_field",
...
var (
	...
	//
	// optional grpc-server.gateway.protoc_gen_openapiv2.options.Swagger openapiv2_swagger = 1042;
...
var (
	...
	// different descriptor messages.
	//
	// optional grpc-server.gateway.protoc_gen_openapiv2.options.Operation openapiv2_operation = 1042;
...
var (
	...
	// different descriptor messages.
	//
	// optional grpc-server.gateway.protoc_gen_openapiv2.options.Schema openapiv2_schema = 1042;
...
var (
	...
	// different descriptor messages.
	//
	// optional grpc-server.gateway.protoc_gen_openapiv2.options.Tag openapiv2_tag = 1042;
...
var (
	...
	// different descriptor messages.
	//
	// optional grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema openapiv2_field = 1042;
...
var file_protoc_gen_openapiv2_options_annotations_proto_goTypes = []interface{}{
	...
	(*Schema)(nil),                      // 7: grpc-server.gateway.protoc_gen_openapiv2.options.Schema
	(*Tag)(nil),                         // 8: grpc-server.gateway.protoc_gen_openapiv2.options.Tag
	(*JSONSchema)(nil),                  // 9: grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema
}
var file_protoc_gen_openapiv2_options_annotations_proto_depIdxs = []int32{
	0,  // 0: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_swagger:extendee -> google.protobuf.FileOptions
	1,  // 1: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_operation:extendee -> google.protobuf.MethodOptions
	2,  // 2: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_schema:extendee -> google.protobuf.MessageOptions
	3,  // 3: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_tag:extendee -> google.protobuf.ServiceOptions
	4,  // 4: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_field:extendee -> google.protobuf.FieldOptions
	5,  // 5: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_swagger:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Swagger
	6,  // 6: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_operation:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Operation
	7,  // 7: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_schema:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Schema
	8,  // 8: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_tag:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.Tag
	9,  // 9: grpc-server.gateway.protoc_gen_openapiv2.options.openapiv2_field:type_name -> grpc-server.gateway.protoc_gen_openapiv2.options.JSONSchema
